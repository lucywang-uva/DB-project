...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    if (!empty($_POST['btnAction']) && $_POST['btnAction'] == "Sign up") {
        $info = updateInfo($_SESSION['username'], $_POST['maxcal'], $_POST['maxsleep']);
...
<div style="text-align:center">
  <div class="row mb-3 mx-3">
    ...
    <input type="text" class="form-control" name="maxcal" style="width:200px"
    />        
  </div>

   <div class="row mb-3 mx-3">
   <label>Daily Sleep Goal:<label>
    <input type="text" class="form-control" name="maxsleep" style="width:200px"
    />
  </div>
  </div>
